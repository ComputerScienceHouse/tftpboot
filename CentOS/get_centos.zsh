...
getall() {
     ...
     wget -O $DIRECTORY/initrd_7_32.img "http://mirrors.rit.edu/centos/7/os/i386/images/pxeboot/initrd.img"
     ...
     wget -O $DIRECTORY/vmlinuz_7_32 "http://mirrors.rit.edu/centos/7/os/i386/images/pxeboot/vmlinuz"
...
if [ ! -f $DIRECTORY/initrd_7_32.img ]; then
    wget -O $DIRECTORY/initrd_7_32.img "http://mirrors.rit.edu/centos/7/os/i386/images/pxeboot/initrd.img"
fi
...
if [ ! -f $DIRECTORY/vmlinuz_7_32 ]; then
    wget -O $DIRECTORY/vmlinuz_7_32 "http://mirrors.rit.edu/centos/7/os/i386/images/pxeboot/vmlinuz"
fi
